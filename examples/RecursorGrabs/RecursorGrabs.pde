 ...
 * Use RecursorGrabber to grab screenshots of based on RecursorQueue activity. 
 * Press space to restart sketch and activate grabber. 
 */
...
RecursorGrabber grabber = new RecursorGrabber(this, rq, 512);
